      ...
      <div className=" ml-10 mr-10 mb-10">
        <div className={`border-solid border-[3px] ${darkmode === "dark" ? "bg-black border-[#4B3D10]" : "bg-white border-[#B7A261]"
          ...
          <p
            style={{ color: `${bgcolor === "white" ? "#000000" : "#A6A6A6"}` }}
          >
            Noteworthy <span className={`font-bold ${bgcolor === "white" ? "text-black" : "text-white"}`}> Achievement </span> of my career is that our team ranked <span className={`font-bold ${bgcolor === "white" ? "text-black" : "text-white"}`}> 3rd at Interns hackathon of IBM.</span> Additionaly in my student life we ranked in <span className={`font-bold ${bgcolor === "white" ? "text-black" : "text-white"}`}> Top 10 Teams at hackathon </span> hosted by <span className={`font-bold ${bgcolor === "white" ? "text-black" : "text-white"}`}> IEEE SB at DAIICT, Gandhinagar. </span>Also as UI/UX Designer my several apps and website designs are currently being used in production.
            <br /><br />{" "}
