    ...
    <>
      ...
      <div className="w-full flex justify-around">
        ...
        >
          ...
          <h1
            className={`text-xl font-bold relative lg:top-20 mt-2 sm:top-24 ${bgcolor === "white" ? "text-black" : "text-[#CCC0C0]"
              }`}
          >
            Vishu K Bhingradiya
          </h1>
          ...
          <div className="flex relative top-5">
            <button className={`${bgcolor === "white" ? "bg-[#B7A261]" : "bg-[#C2B293] "}   flex items-center rounded-lg justify-center p-2 text-lg text-nowrap w-36 h-10`}>
              ...
              <a href={"https://drive.google.com/file/d/1eaJkUnqlzxxbgmUVJYyhiQzf3-47_2nh/view?usp=sharing"} className="flex gap-2 text-[#3B3729] ">
                {" "}
                <p><b>View Resume</b></p>
              </a>
            </button>
